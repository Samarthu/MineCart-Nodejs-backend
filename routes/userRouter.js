...
const {getUser,getAllUser,updateUser,deleteUser,updateProfileImage}=require('../controllers/userController');
...
const upload = multer({
  ...
  userRouter.get('/ProfileImage',(req,res)=>{
      res.sendFile("/Users/samarth/MimeCart/backend/multer.html");
  });
